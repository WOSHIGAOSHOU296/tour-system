...
<div class="container">
    <div class="page-header" style="border:none;">
        <h2 style="color:#bf360c;font-weight:bold;">&#9997; 创建新行程</h2>
    </div>

    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel form-panel">
                <div class="panel-heading">规划你的旅行</div>
                    ...
                    <form action="trip" method="post" onsubmit="return checkForm()">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="tripName" id="tripName" class="form-control"
                                   placeholder="例如：我的北京三日游" maxlength="50" required>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>行程安排</label>
                            <p class="text-muted small" style="margin:0 0 8px;">手动填写景点、住宿、美食安排（可参考下方景点列表）</p>
                            <textarea name="tripContent" class="form-control" rows="12"
                                      placeholder="第一天：上午参观故宫，中午去全聚德吃烤鸭，晚上住王府井希尔顿...&#10;第二天：上午爬长城，下午回市区逛南锣鼓巷...&#10;第三天：..." maxlength="1000"></textarea>
                        </div>
